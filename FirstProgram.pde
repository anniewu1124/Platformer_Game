...
void setup(){
  ...
  player=loadImage("image/player_stand_right.png");
  ...
  gold =loadImage("image/gold1.png");
  spider =loadImage("image/spider.png");
  red_brick =loadImage("image/red_brick.png");
  brown_brick =loadImage("image/brown_brick.png");
  crate=loadImage("image/crate.png");
  snow=loadImage("image/snow.png");
  createPlatforms("image/map.csv");
...
void displayAll(){
  ...
  text("Lives: "+ liveCount, view_x+50, view_y+50);
...
public ArrayList<Sprite> checkCollision(Sprite s, ArrayList<Sprite> list){
...
void keyPressed(){
  ...
  else if (key== 'a' && isOnPlatforms(p, platforms)){
